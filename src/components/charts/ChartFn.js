...
, _fCrTick = (
  ...
  ? (value / number).toFixed(1).replace(".0", "") + suffix
  : "0"
...
export const formatTicks = (
  ...
  return _isMillionCase(_item2, _itemN)
    ? _crMillionTick(value)
    : _isThousandCase(_item2, _itemN)
    ? _crThousandTick(value)
    : ""+value;
}
