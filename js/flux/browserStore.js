...
const [_crMsBrowser, _selectMsBrowser] = (0, _storeApi.fCrStoreSlice)("msBrowser", "id"),
  ...
  _crMsBrowserDynamicElBrowser = (0, _storeApi.fCrMsFromPropNames)(_crMsBrowserDynamic, "elBrowser"),
  _crMsBrowserDynamicBrowserType = (0, _storeApi.fCrMsFromPropNames)(_crMsBrowserDynamic, "browserType", "menuItems");
const _crStore = () => ({
    ..._crMsBrowser(),
    ..._crMsBrowserDynamic()
  }),
