...
var obj0 = {},
  ...
  arr = [item0, item1];
var _testFindInArrEdgeCases = function _testFindInArrEdgeCases(fn) {
  ...
  expect(fn('p1', function () {}, 'a')).toBe(void 0);
};
describe('findByPropNameInArrIndex', function () {
  ...
  test('should return void 0 in edge cases', function () {
    _testFindInArrEdgeCases(fn);
  });
});
describe('findByPropNameInArrItem', function () {
  var fn = _arrFn.findByPropNameInArrItem;
  test('should return first item by propName and value from array', function () {
